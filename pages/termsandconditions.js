    ...
    <div className="p-8 bg-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose">
          ...
          <p>1.1 These terms and conditions ("Terms") govern the provision of business English coaching services ("Services") by [Your Business Name], hereinafter referred to as "we," "us," or "our," to South Korean business executives, hereinafter referred to as "clients" or "you."</p>

          <h2>2. Service Description</h2>

          <p>2.1 Our Services aim to provide tailored, one-on-one business-focused English language tuition to enhance your English language skills for professional purposes.</p>

          <h2>3. Payment Terms</h2>

          <p>3.1 Payment for Services is due in advance and must be made in accordance with the payment method specified by us.</p>

          <p>3.2 All fees are non-refundable unless otherwise specified in writing.</p>
          ...
          <p>5.1 To maximize the benefits of our Services, you agree to actively participate, complete assigned coursework, and adhere to any recommendations provided by our coaches.</p>

          <h2>6. Confidentiality</h2>

          <p>6.1 We will treat all client information as confidential and will not disclose it to third parties without your consent, except as required by law.</p>

          <h2>7. Termination</h2>

          <p>7.1 We reserve the right to terminate our coaching relationship with you if you engage in any behavior that is disruptive or violates these Terms.</p>
